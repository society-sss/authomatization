...
🧠 Содержание и текст:
в форме указать два поля для имени и email и пока пользователь не заполнит все данные кнопка получить книгу не сработает а если все заполнено то при нажатии на получить книгу пользователя отправит на страницу ./pages/thank/thank.html
